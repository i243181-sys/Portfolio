...
- Retains the template’s dark navy palette, gradient headings, centered hero, split about/contact sections, project grid, timeline, and neural background.
- Project illustrations are abstract icon treatments, not product screenshots. The about section uses a monogram because no personal photo was supplied.
